...
Route::prefix('units')->group(function () {
    ...
    Route::get('/{unit}/edit', \Modules\Aoe2Notebook\Http\Livewire\Unit\Edit::class)->name('admin.aoe2notebook.units.edit');
    Route::get('/{unit}', \Modules\Aoe2Notebook\Http\Livewire\Unit\Show::class)->name('admin.aoe2notebook.units.show');
});
